...
const NF_A_CONFIG: NFConfig = {
  dbPath: '../cluster-a/database-nf-a.sqlite',
  dbEncryptionKey: 'ed9733675a04a20b91c5beb2196a6c964dce7d520a77be577a8a605911232ba6',
  issuerDid: 'did:web:kiuyenzo.github.io:Prototype:cluster-a:did-issuer-a',
  subjectDid: 'did:web:kiuyenzo.github.io:Prototype:cluster-a:did-nf-a',
  clusterId: 'cluster-a',
  nfName: 'NF-A'
};

const NF_B_CONFIG: NFConfig = {
  dbPath: '../cluster-b/database-nf-b.sqlite',
  dbEncryptionKey: '3859413b662c8fc7e632cda1fe9d5f07991c0b5d2bd2d8a69fa36e9e25cfef1d',
  issuerDid: 'did:web:kiuyenzo.github.io:Prototype:cluster-b:did-issuer-b',
 ...
 */
async function createNetworkFunctionCredential(config: NFConfig) {
  console.log(`\n${'='.repeat(80)}`);
  ...
  try {
    ...
    const nfCredentials = savedCredentials.filter(
...
async function main() {
  ...
  try {
    // Create credential for NF-A
    await createNetworkFunctionCredential(NF_A_CONFIG);

    // Create credential for NF-B
