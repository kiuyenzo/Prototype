(function (factory) {
  ...
  protoOf(AtomicRef).u2j = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).v2j = function () {
  ...
  protoOf(AtomicBoolean).w2j = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).v2j = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).x2j = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).v2j = function () {
    return this.kotlinx$atomicfu$value;
  };
