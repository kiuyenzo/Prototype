...
// const vp_creation_manuell_js_1 = require("../credentials/pex/vp-pex.js"); // PEX
const vp_creation_manuell_js_1 = require("../credentials/sdr/vp-sdr.js"); // SDR aktiv
...
class DIDCommVPWrapper {
    ...
    async handleVPAuthRequest(message, ourDid, credentials, ourPresentationDefinition) {
        ...
        try {
            ...
            const vp = await (0, vp_creation_manuell_js_1.createVPFromSDR)(this.agent, ourDid, credentials, message.body.presentation_definition, message.from);
            context.ourVP = vp;
    ...
    async handleVPWithPD(message, credentials, ourDid, ourPresentationDefinition) {
        ...
        try {
            ...
            const verificationResult = await (0, vp_creation_manuell_js_1.verifyVPAgainstSDR)(this.agent, message.body.verifiable_presentation, context.ourPresentationDefinition);
            ...
            const ourVP = await (0, vp_creation_manuell_js_1.createVPFromSDR)(this.agent, context.ourDid, credentials, message.body.presentation_definition, message.from);
            context.ourVP = ourVP;
