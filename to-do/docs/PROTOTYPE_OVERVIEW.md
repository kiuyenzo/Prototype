...
│                                                                          │
│  PeerAuthentication (deploy/mtls-config/mtls-*.yaml)                    │
│  ├── Encrypted: mode: PERMISSIVE (Plain + mTLS accepted)                │
│  └── Signed: mode: STRICT (Only mTLS accepted)                          │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
```
...
│   ├── mtls-encrypted.yaml         # PeerAuth: PERMISSIVE (Encrypted mode)
│   ├── mtls-signed.yaml            # PeerAuth: STRICT (Signed mode)
