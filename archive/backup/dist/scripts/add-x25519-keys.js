    ...
    const agent = createAgent({
        plugins: [
            new KeyManager({
                ...
                kms: {
                    local: new KeyManagementSystem(new PrivateKeyStore(dbConnection, new SecretBox('ed9733675a04a20b91c5beb2196a6c964dce7d520a77be577a8a605911232ba6')))
                }
            }),
            new DIDManager({
    ...
    const agent = createAgent({
        plugins: [
            new KeyManager({
                store: new KeyStore(dbConnection),
                kms: {
                    local: new KeyManagementSystem(new PrivateKeyStore(dbConnection, new SecretBox('3859413b662c8fc7e632cda1fe9d5f07991c0b5d2bd2d8a69fa36e9e25cfef1d')))
                }
            }),
            new DIDManager({
                store: new DIDStore(dbConnection),
...
// ============================================================================
function generateDIDDocumentUpdate(did, x25519PublicKeyHex) {
