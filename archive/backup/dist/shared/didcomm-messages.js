 ...
 */
export function createVPAuthRequest(from, to, presentationDefinition, comment) {
    return {
 ...
 */
export function createVPWithPD(from, to, verifiablePresentation, presentationDefinition, comment) {
    return {
 ...
 */
export function createVPResponse(from, to, verifiablePresentation, comment) {
    return {
 ...
 */
export function createAuthConfirmation(from, to, status, sessionToken, comment) {
    return {
 ...
 */
export function createServiceRequest(from, to, service, action, params, sessionToken) {
    return {
 ...
 */
export function createServiceResponse(from, to, status, data, error) {
    return {
 ...
 */
export function createErrorMessage(from, to, code, comment) {
    return {
