 ...
 */
export const PRESENTATION_DEFINITION_A: PresentationDefinition = {
 ...
 */
export const PRESENTATION_DEFINITION_B: PresentationDefinition = {
 ...
 */
export const PRESENTATION_DEFINITION_SPECIFIC_CLUSTER: PresentationDefinition = {
