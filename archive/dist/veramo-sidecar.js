...
async function sendDIDCommMessage(message, targetDid) {
    ...
    const payload = JSON.stringify({ encrypted: true, message: encryptedMessage });
    // Determine target host for routing
    const targetHost = targetDid.includes('cluster-a')
